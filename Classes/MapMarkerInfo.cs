...
public class MapMarkerInfo
{
    ...
    /// <summary>
    ///     A path to a file on the filesystem, if a IconId or Texture is set before setting this, they'll be replaced with the
    ///     loaded texture.
    /// </summary>
    ...
    /// <summary>
    ///     If <see langword="true" /> will show this marker in any map. If <see langword="false" /> will only show in the map
    ///     that matches <see cref="MapId" />
    /// </summary>
