...
/// </summary>
/// <remarks>
///     Only one of (ItemInfo) or (ItemRenderer) will be valid at a time depending on the specific list being interacted
///     with.
/// </remarks>
public unsafe class ListItemData
{
    /// <summary>
    ///     Pointer to the lists ItemInfo. If this is valid, then you can use <see cref="GetNumber" /> or
    ///     <see cref="GetString" />
    ...
    /// </summary>
    /// <remarks>
    ///     It is recommended to decompile the populator function for this list, to see which indexes of the NodeList are used
    ///     for what ui parts.
    /// </remarks>
    public AtkResNode** NodeList { get; init; }

    /// <summary>
    ///     This item index in the list. This will also be the index used for accessing data from wherever this list stores the
    ///     data.
    /// </summary>
