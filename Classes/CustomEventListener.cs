...
public class CustomEventListener : IDisposable, IAsyncDisposable
{
    ...
    /// </summary>
    public unsafe CustomEventListener
    (
        AtkEventListener.Delegates.ReceiveEvent eventHandler
    )
    {
        ...
        eventListener->VirtualTable->ReceiveGlobalEvent =
            (delegate* unmanaged<AtkEventListener*, AtkEventType, int, AtkEvent*, AtkEventData*, void>)(delegate* unmanaged<void>)&NullSub;
        eventListener->VirtualTable->ReceiveEvent =
            (delegate* unmanaged<AtkEventListener*, AtkEventType, int, AtkEvent*, AtkEventData*, void>)Marshal.GetFunctionPointerForDelegate(receiveEventWrapper);
    }
    ...
    /// </summary>
    public static unsafe implicit operator AtkEventListener*
    (
    ...
    private unsafe void ReceiveEventWrapper
    (
        AtkEventListener* thisPtr,
        AtkEventType      eventType,
        int               param,
        AtkEvent*         eventObject,
        AtkEventData*     data
    )
    {
        try
