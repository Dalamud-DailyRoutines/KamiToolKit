...
public unsafe class IconExtras : ResNode
{
    ...
    private void BuildTimelines()
    {
        ...
        AlternateCooldownNode.AddTimeline
        (
            new TimelineBuilder()
                .BeginFrameSet(1, 205)
        ...
        HoveredBorderImageNode.AddTimeline
        (
            new TimelineBuilder()
                .BeginFrameSet(10, 19)
        ...
        ClickFlashImageNode.AddTimeline
        (
            new TimelineBuilder()
                .BeginFrameSet(20, 29)
