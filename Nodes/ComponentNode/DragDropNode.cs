...
public unsafe class DragDropNode : ComponentNode<AtkComponentDragDrop, AtkUldComponentDataDragDrop>
{
    ...
    private void DragDropInsertHandler
    (
        AtkEventListener* thisPtr,
        AtkEventType      eventType,
        int               eventParam,
    ...
    private void DragDropDiscardHandler
    (
        AtkEventListener* thisPtr,
        AtkEventType      eventType,
        int               eventParam,
    ...
    private void DragDropEndHandler
    (
        AtkEventListener* thisPtr,
        AtkEventType      eventType,
        int               eventParam,
    ...
    private void DragDropClickHandler
    (
        AtkEventListener* thisPtr,
        AtkEventType      eventType,
        int               eventParam,
    ...
    private void LoadTimelines() => AddTimeline
    (
        new TimelineBuilder()
            .BeginFrameSet(1, 59)
            .AddLabelPair(1,  10, 1)
