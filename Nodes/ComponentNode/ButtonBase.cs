...
public abstract unsafe class ButtonBase : ComponentNode<AtkComponentButton, AtkUldComponentDataButton>
{
    ...
    /// </summary>
    protected static void LoadTwoPartTimelines
    (
        NodeBase parent,
        NodeBase foreground
    )
    ...
    /// </summary>
    protected static void LoadThreePartTimelines
    (
        NodeBase parent,
        NodeBase background,
        NodeBase foreground,
        Vector2  foregroundPositionOffset
    )
    {
        parent.AddTimeline
        (
