...
/// <summary>
///     Extension provider for IDalamudService, to add a .Get() method to get an instance of any dalamud service directly
///     from typename.
/// </summary>
/// <code>
...
internal class Services
{
    ...
    private static string GetAssetDirectoryPath()
        => Path.Combine
            (KamiToolKitLibrary.PluginInterface.AssemblyLocation.DirectoryName ?? throw new Exception("Directory from Dalamud is Invalid Somehow"), "Assets");
}
