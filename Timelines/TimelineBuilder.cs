...
public class TimelineBuilder
{
    ...
    public FrameSetBuilder BeginFrameSet
    (
        int startFrameId,
        int endFrameId
    )
    ...
    /// <summary>
    ///     Begins a frameset builder for the specified ranges, but targeting a specific frame index for building the
    ///     animation.
    /// </summary>
    public KeyFrameBuilder AddFrame
    (
        int frameSetStart,
        int frameSetEnd,
        int frameIndex
