...
public unsafe class Timeline : IDisposable
{
    ...
    public void PlayAnimation
    (
        AtkTimelineJumpBehavior behavior,
        int                     labelId,
        bool                    force = false
    )
    {
    ...
    private AtkTimelineKeyFrame* GetKeyFrame
    (
        KeyFrameGroupType type,
        int               frameIndex
    )
    {
    ...
    private AtkTimelineAnimation* GetAnimationForFrameId
    (
        int frameId
    )
    {
