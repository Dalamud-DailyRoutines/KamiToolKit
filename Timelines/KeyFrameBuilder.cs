...
)
{
    ...
    /// </summary>
    public KeyFrameBuilder Position
    (
        Vector2 position
    )
    {
    ...
    /// </remarks>
    public KeyFrameBuilder AddColor
    (
        Vector3 color
    )
    {
    ...
    /// </remarks>
    public KeyFrameBuilder MultiplyColor
    (
        Vector3 color
    )
    {
    ...
    /// </remarks>
    public KeyFrameBuilder RotationDegrees
    (
        float degrees
    )
    {
    ...
    /// </remarks>
    public KeyFrameBuilder Rotation
    (
        float rotation
    )
    {
    ...
    /// </summary>
    public KeyFrameBuilder TextColor
    (
        Vector3 textColor
    )
    {
    ...
    /// </summary>
    public KeyFrameBuilder TextOutlineColor
    (
        Vector3 textColor
    )
    {
    ...
    /// </summary>
    /// <example>
    ///     For the ants animation the game will loop through parts 0 -> 16 using a keyframe set to 0 and another keyframe set
    ///     to 16.
    /// </example>
    public KeyFrameBuilder Part
    (
        uint partId
    )
    {
