...
public static class PluginLogExtensions
{
    ...
    ///     Enabling this will likely spam the log several times a frame as events such as Draw and Update are logged to
    ///     Excessive.
    /// </summary>
    ...
    )
    {
        ...
        /// <summary>
        ///     Logs a message with excessive logging, can be toggled with
        ///     <see cref="PluginLogExtensions.EnableExcessiveLogging" />
        /// </summary>
