...
public static class AtkEventDataExtensions
{
    ...
    )
    {
        ...
        /// <summary>
        ///     Gets the scroll intensity, this is the per-frame value for the scroll, its value can be as low as 0/1 or as high as
        ///     10/20+ depending on scroll speed.
        /// </summary>
